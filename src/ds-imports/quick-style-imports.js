...
const stylesDir = path.resolve(__dirname, PATH.DS.QUICK + '/Styles');

// 📄 Path to the output file (that you'll import into your React app)
const outputFile = path.resolve(__dirname, '../../src/styles/DanskeSpil/Quick.less');
...
const imports = files
.map((file) => `@import "@PATH.DS.QUICK/Styles/${file}";`)
.join('\n');
